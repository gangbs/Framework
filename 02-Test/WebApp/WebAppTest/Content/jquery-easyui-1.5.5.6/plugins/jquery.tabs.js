...
(function ($) {
    ...
    function _2(_3) {
        ...
        if (_4.tabPosition == "left" || _4.tabPosition == "right") {
            ...
            var _a = {
                left: _4.tabPosition == "left" ? "auto" : 0,
                right: _4.tabPosition == "left" ? 0 : "auto",
                top: _4.toolPosition == "top" ? 0 : "auto",
                bottom: _4.toolPosition == "top" ? "auto" : 0
            };
        ...
        if (_d > _e) {
            ...
            if (_4.toolPosition == "left") {
                ...
                _9.css({
                    ...
                    width: _e - _7.outerWidth() - _8.outerWidth()
                });
            } else {
    ...
    function _2a(_2b) {
        ...
        cc.children("div.tabs-panels").children("div").each(function (i) {
            var _2e = $.extend({}, $.parser.parseOptions(this), {
    ...
    function _3e(_3f, _40, pp) {
        ...
        pp.panel($.extend({}, _40, {
            ...
            closed: true,
            doSize: false,
            iconCls: (_40.icon ? _40.icon : undefined),
            onLoad: function () {
                if (_40.onLoad) {
    ...
    $.fn.tabs = function (_89, _8a) {
        ...
        return this.each(function () {
            ...
            if (_8b) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _89),
                    tabs: [],
                    selectHis: []
                });
                _2a(this);
    ...
    $.fn.tabs.parseOptions = function (_9d) {
        return $.extend({}, $.parser.parseOptions(_9d, ["tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
