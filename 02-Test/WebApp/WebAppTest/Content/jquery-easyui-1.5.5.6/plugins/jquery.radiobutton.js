...
(function ($) {
    ...
    $.fn.radiobutton = function (_23, _24) {
        ...
        return this.each(function () {
            ...
            if (_25) {
                ...
                _25 = $.data(this, "radiobutton", {
                    options: $.extend({}, $.fn.radiobutton.defaults, $.fn.radiobutton.parseOptions(this), _23),
                    radiobutton: _2(this)
                });
            }
    ...
    $.fn.radiobutton.parseOptions = function (_29) {
        var t = $(_29);
        return $.extend({}, $.parser.parseOptions(_29, ["label", "labelPosition", "labelAlign", {labelWidth: "number"}]), {
