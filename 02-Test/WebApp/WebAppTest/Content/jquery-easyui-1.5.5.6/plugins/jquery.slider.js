...
(function ($) {
    ...
    $.fn.slider = function (_43, _44) {
        ...
        return this.each(function () {
            ...
            if (_45) {
                ...
                _45 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _43),
                    slider: _1(this)
                });
    ...
    $.fn.slider.parseOptions = function (_4c) {
        var t = $(_4c);
        return $.extend({}, $.parser.parseOptions(_4c, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
